...
*/
window.Round = class Round {
    constructor(roundNumber) {
        // NEW: pull from global map instead of require()
        if (!window.ROUNDS || !window.ROUNDS[roundNumber]) {
            throw new Error('Round data missing for #' + roundNumber);
        }
        let round = window.ROUNDS[roundNumber];
